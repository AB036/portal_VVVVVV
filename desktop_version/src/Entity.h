...
public:
    ...
    void line_collision_bounds(int xa, int ya, int xb, int yb, int* xmin, int* ymin, int* xmax, int* ymax);
    ...
    char blue_portal_orientation;
    char orange_portal_orientation;
    int player_portal_teleport_cooldown;
};
